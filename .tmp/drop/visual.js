var dialogBoxA8CADB85C6284C0BB03865DDBEBEF029_DEBUG;
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   c: () => (/* binding */ TestDialog)
/* harmony export */ });
/* harmony import */ var purejs_color_picker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(410);
...
class TestDialog {
    ...
    constructor(options, initialState) {
        ...
        (0,purejs_color_picker__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)({
            host: this.target,
            handler: (color) => {
...
/* harmony export */ });
/* harmony import */ var _test_dialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(458);
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(163);
/* harmony import */ var purejs_color_picker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(410);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8976);
...
class Visual {
    target;
    settings;
    dialogActionsButtons = [1 /* DialogAction.OK */, 2 /* DialogAction.Cancel */];
    host;
    isDialog = false;
    constructor(options) {
        console.log("Visual constructor", options);
        this.target = options.element;
        this.host = options.host;
        (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .select */ .Ys)(this.target).append("div").attr("type", "color").attr("id", "colorPicker");
        if (document) {
            const button = document.createElement("BUTTON");
            button.innerHTML = "Open Dialog, please";
            button.onclick = () => {
                ...
                this.host.openModalDialog(_test_dialog__WEBPACK_IMPORTED_MODULE_0__/* .TestDialog */ .c.id, dialogOptions).catch((error) => console.log("error:", error));
            };
            this.target.appendChild(button);
        }
    }
    update(options) {
        ...
        colorPicker.addEventListener("click", (event) => {
            (0,purejs_color_picker__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)({
                host: this.target,
                handler: (color) => {
                    // Do something with the selected color
                    console.log("Selected Color:", color);
    ...
    static parseSettings(dataView) {
        return _settings__WEBPACK_IMPORTED_MODULE_1__/* .VisualSettings */ .J.parse(dataView);
    }
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ PickerUI)
/* harmony export */ });
function PickerUI(picker) {
  return PickerUI = {
    type: "div",
    ref: "mainContainer",
    events: {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ showColorPicker)
/* harmony export */ });
/* harmony import */ var _PickerUI_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(803);
...
class ColorPicker {
  ...
  constructor() {
    ...
    this.createElementFromObject((0,_PickerUI_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(this));
...
function showColorPicker ({host,color, handler, pickerStyle,dismissable}) {
...
/* harmony export */ });
/* harmony import */ var _src_visual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(966);

var powerbiKey = "powerbi";
var powerbi = window[powerbiKey];
var dialogBoxA8CADB85C6284C0BB03865DDBEBEF029_DEBUG = {
    name: 'dialogBoxA8CADB85C6284C0BB03865DDBEBEF029_DEBUG',
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["dialogBoxA8CADB85C6284C0BB03865DDBEBEF029_DEBUG"] = dialogBoxA8CADB85C6284C0BB03865DDBEBEF029_DEBUG;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (dialogBoxA8CADB85C6284C0BB03865DDBEBEF029_DEBUG);

})();

dialogBoxA8CADB85C6284C0BB03865DDBEBEF029_DEBUG = __webpack_exports__;
/******/ })()
;
